                ...
                obj.on('click', function(e){
                    ...
                    overlay.animate({opacity:1}, 250, function(){
                        ...
                        if (obj.data('vbtype') == 'iframe') {
                          ...
                          if(dest.indexOf("-||-") > -1){
                            var imgContent = "";
                            var splittedDest = dest.split("-||-");
                            for (var indexLoop = 0; indexLoop < splittedDest.length; indexLoop++) {
                              imgContent += '<img src="'+splittedDest[indexLoop]+'" class="vbox-figlio" style="padding: 0px; background: rgb(255, 255, 255);">';
                            }
                            content.html(imgContent);
                          }else{
